...
-- Update company sizes: set unknown companies (previously estimated as 100) to 0
-- This preserves companies that actually have 100 employees while marking unknowns as 0
-- Note: This is a best-effort migration. Companies with exactly 100 employees that are actually unknown will remain as 100.
-- UPDATE companies SET employee_count = 0 WHERE employee_count = 100; -- Run this manually if needed