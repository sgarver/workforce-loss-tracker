...
- [x] fix industry is missing
- [x] employee count under employee name is 0
- [x] add pagination
- [x] make filters section collapsed by default
...
Last updated: 2026-01-31 13:59 PST (move prod DB to /var/lib and add DATABASE_PATH config)
